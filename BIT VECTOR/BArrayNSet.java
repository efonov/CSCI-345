...
//    	print(internal);
        ...
        BArrayNSet union = new BArrayNSet(internal.length);
        checkParameter(other);
        for(int i = 0; i < internal.length; i++) {
        	boolean check = internal[i] || other.contains(i);
        	union.internal[i] = check;
        	}
...
//    	print(internal);
    	...
    	BArrayNSet intersection = new BArrayNSet(internal.length);
        checkParameter(other);
        for(int i = 0; i < internal.length; i++) {
        	boolean check = internal[i] && other.contains(i);
        	intersection.internal[i] = check;
        	}
...
//    public void print(NSet toPrint) {
//		System.out.print("[");
//    	for(int i = 0; i < toPrint.range(); i++) {
//    		if(toPrint.contains(i)) System.out.print("T, ");
//    		else System.out.print("F, ");
//    	}
////		if(toPrint.contains(size()-1)) System.out.print("T]\n");
////		else System.out.print("F]\n");
//    }
...
//    		if(toPrint[i]) System.out.print("T, ");
//    		else System.out.print("F, ");
//    	}
//		if(toPrint[toPrint.length-1]) System.out.print("T]\n");
//		else System.out.print("F]\n");    
//    }
...
//    	print(internal);
    	...
    	BArrayNSet difference = new BArrayNSet(internal.length);
        checkParameter(other);
        for(int i = 0; i < internal.length; i++) {
        	boolean check = internal[i] && !other.contains(i);
        	difference.internal[i] = check;
        	}
    ...
    public Iterator<Integer> iterator() {
        ...
        return new Iterator<Integer>() {
            ...
            public Integer next() {
            	...
            	current++;
                while (current < internal.length && !internal[current]) current++;
